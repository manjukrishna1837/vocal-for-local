...
function Home(props) {
  ...
  let elec1=["New Era Electrical Shop","Sannidhi electricals","Kl Enterprises","Vadda Electricals"];
  let groceries = [
  ...
  let electronics1=["Baliga stores","Margin Free Store","Mahashwari Enterprises","Mritika Stores "];
...
"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSzXvQp_FoNnmRLLyM__pZS37iPfDLHmkMhLQ&usqp=CAU"
  ...
  let res1=[
    "Hotel Vardhaman","Vihar","Salwa","Hotel Anand"  ]
    ...
    <div>
      <Grid container spacing={2}>
        ...
        <div className="home__section">
          ...
          <Card arr={electrical} arr1={elec1}/>
        </div>
        <div className="home__section">
